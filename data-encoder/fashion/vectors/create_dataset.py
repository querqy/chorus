...
dir = products.get_all_filenames(PATH_PRODUCTS_DATASET + "chunked-json")
for prod_file in dir:
    print("processing file"+prod_file)
    #### Load the original products dataset
    products_dataset = products.load_products_dataset(prod_file)
    ...
    products.export_products_json(products_dataset,prod_file)
